...
class AgentSessionOptions:
    ...
    backchanneling_ignore_words: list[str] | None
    backchanneling_interrupt_words: list[str] | None
...
class AgentSession(rtc.EventEmitter[EventTypes], Generic[Userdata_T]):
    def __init__(
        ...
        *,
        ...
        backchanneling_ignore_words: list[str] | None = None,
        backchanneling_interrupt_words: list[str] | None = None,
        ...
        self._opts = AgentSessionOptions(
            ...
            backchanneling_ignore_words=backchanneling_ignore_words,
            backchanneling_interrupt_words=backchanneling_interrupt_words,
        )
